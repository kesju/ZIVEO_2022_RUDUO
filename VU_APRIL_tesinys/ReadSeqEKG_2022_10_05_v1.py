...
# Rl/Rr.
# Skriptas dar dirba su senesniu duomenų variantu:
...
train_set_idx = pd.read_csv(Path(db_path, 'train_ind_lst_tst.csv'), header = None)
train_set_idx_lst = list(train_set_idx[0])
print(f'train_set_idx_lst: {train_set_idx_lst}')
train_set_data, omitted = apply_FDA(train_set_idx_lst, all_beats_attr)
print("\n", "train_set_data DATA:")
# train_set_data.info()
...
# test_set_data, omitted = apply_FDA_vasara(test_set_idx, all_beats_attr)
