...
def get_spike_width(orig, derivate, reample_points, positions):
    # variantas, kai dar naudoja atgyvenusiį append
...
# Variantas, gautas iš Povilo, nepakeisti append į concat, pritaikytas modeliui 0 - pavasario modelis
...
#  Išėjimo parametrai: pred_y, kai kurie neatpažinti : 'U':3
    ...
    all_features = ['seq_size','label','RRl', 'RRr', 'RRl/RRr','wl_side','wr_side',
